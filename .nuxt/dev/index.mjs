...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, getRequestHeader, setResponseHeaders, setResponseStatus, send, getRequestHeaders, setResponseHeader, appendResponseHeader, getRequestURL, getResponseHeader, removeResponseHeader, createError, getResponseStatus, getQuery as getQuery$1, readBody, getRouterParam, setHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getResponseStatusText } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { resolve, dirname, join } from 'node:path';
import nodeCrypto from 'node:crypto';
import { parentPort, threadId } from 'node:worker_threads';
import { escapeHtml } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/@vue/shared/dist/shared.cjs.js';
import { createRenderer, getRequestDependencies, getPreloadLinks, getPrefetchLinks } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, decodePath, withLeadingSlash, withoutTrailingSlash, joinRelativeURL } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/ufo/dist/index.mjs';
import destr, { destr as destr$1 } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/destr/dist/index.mjs';
import { createHooks } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/hookable/dist/index.mjs';
import { createFetch, Headers as Headers$1 } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/node-mock-http/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/unstorage/drivers/fs.mjs';
import { digest, hash as hash$1 } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/scule/dist/index.mjs';
import { getContext } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/unctx/dist/index.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/radix3/dist/index.mjs';
import { readFile } from 'node:fs/promises';
import consola, { consola as consola$1 } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/consola/dist/index.mjs';
import { ErrorParser } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/youch-core/build/index.js';
import { Youch } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/youch/build/index.js';
import { SourceMapConsumer } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/source-map/source-map.js';
import { AsyncLocalStorage } from 'node:async_hooks';
import { stringify, uneval } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1, basename, isAbsolute } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/@iconify/utils/lib/index.js';
import { collections } from 'file:///Users/jorgepaez/sites/foggy-hex/.nuxt/nuxt-icon-server-bundle.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/unhead/dist/server.mjs';
import { renderToString } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/vue/server-renderer/index.mjs';
import { walkResolver } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/unhead/dist/utils.mjs';
import localAdapter from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/db0/dist/connectors/better-sqlite3.mjs';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/jorgepaez/sites/foggy-hex/node_modules/ipx/dist/index.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/jorgepaez/sites/foggy-hex/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jorgepaez/sites/foggy-hex","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/jorgepaez/sites/foggy-hex/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jorgepaez/sites/foggy-hex/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/jorgepaez/sites/foggy-hex/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/jorgepaez/sites/foggy-hex/.data/kv"}));
...
const _inlineRuntimeConfig = {
  ...
  "content": {
    ...
    "localDatabase": {
      "type": "sqlite",
      "filename": "/Users/jorgepaez/sites/foggy-hex/.data/content/contents.sqlite"
    },
    "integrityCheck": true
  },
  "nuxt-scripts": {
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/jorgepaez/sites/foggy-hex/public"
      ]
    },
    "http": {
      "domains": []
...
const _Hh4EevBZGNP04MeDXOZiKCqcK_iRpJK9oakK5q4vss = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/jorgepaez/sites/foggy-hex";
...
const _qwzZI9eZOlEZtPgZGOXn6O1YPLjqsnvXImJoTfk1N6o = (nitroApp) => {
...
const plugins = [
  _Hh4EevBZGNP04MeDXOZiKCqcK_iRpJK9oakK5q4vss,
_qwzZI9eZOlEZtPgZGOXn6O1YPLjqsnvXImJoTfk1N6o
];
...
const _3r9vko = eventHandler((event) => {
...
const checksums = {
  ...
  "shows": "v3.5.0--SXLxQGVYJ_W49eM8HyM_bmqfH9myvOcOsx-4N2JR14I"
};
...
const _hAlJz8 = defineCachedEventHandler(async (event) => {
...
const getServerEntry = () => import('file:///Users/jorgepaez/sites/foggy-hex/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/jorgepaez/sites/foggy-hex/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _ZWFrOt = eventHandler(async (event) => {
  ...
  return await import('file:///Users/jorgepaez/sites/foggy-hex/.nuxt/content/database.compressed.mjs').then((m) => m[collection]);
});
...
const _ptNjLb = eventHandler(async (event) => {
...
const _T4z0re = lazyEventHandler(() => {
...
const _lazy_4paGaM = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '', handler: _3r9vko, lazy: false, middleware: true, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_4paGaM, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _hAlJz8, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/sql_dump.txt', handler: _ZWFrOt, lazy: false, middleware: false, method: undefined },
  { route: '/__nuxt_content/:collection/query', handler: _ptNjLb, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _T4z0re, lazy: false, middleware: false, method: undefined },
  { route: '/_scripts/**', handler: _lazy_4paGaM, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_4paGaM, lazy: true, middleware: false, method: undefined }
];
