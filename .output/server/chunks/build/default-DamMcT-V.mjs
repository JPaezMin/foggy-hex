import { _ as __nuxt_component_0$2 } from './nuxt-link-YJOaxN1F.mjs';
...
import __nuxt_component_2 from './index-B6JqO8G9.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<nav${ssrRenderAttrs(mergeProps({ class: "relative px-4 py-6 font-sans text-text" }, _attrs))} data-v-21d38cd7><div class="flex justify-between items-center" data-v-21d38cd7>`);
      ssrRenderSlot(_ctx.$slots, "logo", {}, null, _push, _parent);
      _push(`<ul class="hidden 2xl:flex gap-8 items-end flex-nowrap" data-v-21d38cd7><!--[-->`);
      ssrRenderList(navItems, (item) => {
        _push(`<li data-v-21d38cd7>`);
        if (!item.external) {
          ...
          _push(`<a${ssrRenderAttr("href", item.href)} target="_blank" rel="noopener noreferrer" class="text-[22px] leading-normal border-b-2 border-current pb-2 whitespace-nowrap" data-v-21d38cd7>${ssrInterpolate(item.name)}</a>`);
        }
        _push(`</li>`);
      });
      _push(`<!--]--></ul><button class="2xl:hidden z-50" aria-label="Toggle menu" data-v-21d38cd7><svg class="w-8 h-8 text-text" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" data-v-21d38cd7><path stroke-linecap="round" stroke-linejoin="round"${ssrRenderAttr(
        "d",
        menuOpen.value ? "M6 18L18 6M6 6l12 12" : "M4 6h16M4 12h16M4 18h16"
      )} data-v-21d38cd7></path></svg></button></div>`);
      if (menuOpen.value) {
        _push(`<ul class="absolute py-6 px-6 bg-stone-950 flex flex-col gap-6 mt-4 2xl:hidden text-[24px] leading-normal font-sans" data-v-21d38cd7><!--[-->`);
        ssrRenderList(navItems, (item) => {
          _push(`<li class="text-white" data-v-21d38cd7>`);
          if (!item.external) {
            _push(ssrRenderComponent(_component_NuxtLink, {
              to: item.to,
            ...
            _push(`<a${ssrRenderAttr("href", item.href)} target="_blank" rel="noopener noreferrer" class="block border-b-2 border-current pb-4 whitespace-nowrap" data-v-21d38cd7>${ssrInterpolate(item.name)}</a>`);
          }
          _push(`</li>`);
        });
        _push(`<!--]--></ul>`);
...
const __nuxt_component_0$1 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-21d38cd7"]]);
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "w-full bg-zinc-100 py-6 px-6 border-t border-current text-center" }, _attrs))}><a href="mailto:hola@foggyhexbcn.com" class="font-heading text-xl sm:text-2xl lg:text-[32px] text-text hover:text-accent transition-colors break-words"> hola@foggyhexbcn.com </a></footer>`);
}
...
//# sourceMappingURL=default-DamMcT-V.mjs.map
