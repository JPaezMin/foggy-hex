...
import EventLayout from './EventLayout-Aad2CoIQ.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(event)) {
        _push(ssrRenderComponent(EventLayout, mergeProps({ event: unref(event) }, _attrs), null, _parent));
      } else {
        _push(`<!---->`);
      }
    };
...
//# sourceMappingURL=_slug_-Ckh7Wlem.mjs.map
